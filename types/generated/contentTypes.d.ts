...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    paymentinfo: Attribute.JSON & Attribute.Required;
    transectionid: Attribute.UID & Attribute.Required;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category: Attribute.Enumeration<
      ['tshirt', 'mug', 'jug', 'helicopter', 'bike']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'tshirt'>;
    size: Attribute.String;
    color: Attribute.Enumeration<['red', 'black', 'green']> &
